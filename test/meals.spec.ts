...
describe('Meals routes', () => {
  ...
  it('should be able to create a new meal', async () => {
    ...
    const cookies: string[] = userResponse.get('Set-Cookie')!
  ...
  it('should be able to list all meals from a user', async () => {
    ...
    expect(mealsResponse.body.meals[0].name).toBe('Dinner')
  ...
  it('should be able to get metrics from a user', async () => {
    ...
    await request(app.server)
      ...
      .send({
        ...
        description: 'Breakfast now!',
        isOnDiet: true,
        date: new Date('2024-07-01T08:00:00'),
      })
      .expect(201)
    ...
    await request(app.server)
      ...
      .send({
        ...
        isOnDiet: true,
        date: new Date('2024-07-01T15:00:00'),
      })
      .expect(201)
    ...
    await request(app.server)
      ...
      .send({
        ...
        description: "It's a dinner",
        isOnDiet: true,
        date: new Date('2024-07-01T20:00:00'),
      })
